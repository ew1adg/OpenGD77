...
static void handleCPSRequest(void)
{
	...
	else if (com_requestbuffer[0]=='C')
	{
		...
		switch(command)
		{
			...
			case 1:
				// Clear CPS screen
				menuCPSUpdate(0,0,0,FONT_XS,TEXT_ALIGN_LEFT,0,NULL);
				break;
			case 2:
			...
			case 3:
				// Render CPS screen
				menuCPSUpdate(2,0,0,FONT_XS,TEXT_ALIGN_LEFT,0,NULL);
				break;
			case 4:
				// Turn on the display backlight
				menuCPSUpdate(3,0,0,FONT_XS,TEXT_ALIGN_LEFT,0,NULL);
				break;
			case 5:
				// Close
				if (flashingDMRIDs)
				...
				menuCPSUpdate(6,0,0,FONT_XS,TEXT_ALIGN_LEFT,0,NULL);
				break;
			case 6:
				{
					...
					switch(subCommand)
					{
						...
						case 3:
							// flash green LED
							menuCPSUpdate(4,0,0,FONT_XS,TEXT_ALIGN_LEFT,0,NULL);
							break;
						case 4:
							// flash red LED
							menuCPSUpdate(5,0,0,FONT_XS,TEXT_ALIGN_LEFT,0,NULL);
							break;
						default:
							break;
					}
